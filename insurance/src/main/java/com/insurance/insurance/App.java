...
public class App {
	...
	public static void main(final String[] args) throws InterruptedException, IOException {
		...
		System.setProperty("webdriver.chrome.driver", "D:\\StarAgile\\Assignment\\chromedriver-win64\\chromedriver-win64\\chromedriver.exe");
		...
		driver.get("http://3.108.252.123:8086/contact.html");
		driver.manage().timeouts().implicitlyWait(5L, TimeUnit.SECONDS);
		driver.findElement(By.id("inputName")).sendKeys(new CharSequence[] { "madhu" });
		driver.findElement(By.id("inputNumber")).sendKeys(new CharSequence[] { "9999999999" });
		driver.findElement(By.id("inputMail")).sendKeys(new CharSequence[] { "madhu@gmail.com" });
